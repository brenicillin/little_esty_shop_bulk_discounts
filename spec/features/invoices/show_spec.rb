...
RSpec.describe 'invoices show' do
  before :each do
    ...
    @ii_11 = InvoiceItem.create!(invoice_id: @invoice_1.id, item_id: @item_5.id, quantity: 2, unit_price: 6, status: 1)
    ...
    @discount1 = @merchant1.bulk_discounts.create!(name: "5% Discount", discount: 5, threshold: 5)
  end
